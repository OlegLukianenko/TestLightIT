...
public class FragmentProfileBindingImpl extends FragmentProfileBinding implements lightIT.test.application.generated.callback.OnClickListener.Listener {
    ...
    private FragmentProfileBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (lightIT.test.application.databinding.LayoutProfileProgressBarBinding) bindings[9]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((lightIT.test.application.app.home.ProfileFragment) variable);
        }
        else if (BR.data == variableId) {
            setData((lightIT.test.application.data.retrofit.response.Profile) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((lightIT.test.application.viewmodel.ProfileFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable lightIT.test.application.app.home.ProfileFragment Handler) {
    ...
    public void setData(@Nullable lightIT.test.application.data.retrofit.response.Profile Data) {
        this.mData = Data;
    }
    public void setViewModel(@Nullable lightIT.test.application.viewmodel.ProfileFragmentViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelGetProfileFromApi((android.arch.lifecycle.MutableLiveData<lightIT.test.application.data.retrofit.ResponseWrap<lightIT.test.application.data.retrofit.response.Profile>>) object, fieldId);
            case 1 :
                return onChangeIncludeLayoutProgressBar((lightIT.test.application.databinding.LayoutProfileProgressBarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelGetProfileFromApi(android.arch.lifecycle.MutableLiveData<lightIT.test.application.data.retrofit.ResponseWrap<lightIT.test.application.data.retrofit.response.Profile>> ViewModelGetProfileFromApi, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeIncludeLayoutProgressBar(lightIT.test.application.databinding.LayoutProfileProgressBarBinding IncludeLayoutProgressBar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        lightIT.test.application.data.retrofit.response.Profile viewModelGetProfileFromApiData = null;
        lightIT.test.application.data.retrofit.ResponseWrap<lightIT.test.application.data.retrofit.response.Profile> viewModelGetProfileFromApiGetValue = null;
        android.arch.lifecycle.MutableLiveData<lightIT.test.application.data.retrofit.ResponseWrap<lightIT.test.application.data.retrofit.response.Profile>> viewModelGetProfileFromApi = null;
        java.lang.String viewModelGetProfileFromApiDataHtmlUrl = null;
        lightIT.test.application.app.home.ProfileFragment handler = mHandler;
        ...
        lightIT.test.application.viewmodel.ProfileFragmentViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            lightIT.test.application.utils.BindingAdapters.setAvatar(this.profileImage, viewModelGetProfileFromApiDataAvatarUrl);
