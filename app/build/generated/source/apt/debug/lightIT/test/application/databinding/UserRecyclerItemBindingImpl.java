...
public class UserRecyclerItemBindingImpl extends UserRecyclerItemBinding implements lightIT.test.application.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.data == variableId) {
            setData((Product) variable);
        }
        else if (BR.adapter == variableId) {
            setAdapter((lightIT.test.application.app.home.adapter.UserRecyclerAdapter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setData(@Nullable Product Data) {
        this.mData = Data;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    public void setAdapter(@Nullable lightIT.test.application.app.home.adapter.UserRecyclerAdapter Adapter) {
    ...
    protected void executeBindings() {
        ...
        Product data = mData;
        lightIT.test.application.app.home.adapter.UserRecyclerAdapter adapter = mAdapter;
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            lightIT.test.application.utils.BindingAdapters.setAvatar(this.image, dataAvatarUrl);
        }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        lightIT.test.application.app.home.adapter.UserRecyclerAdapter.UserItemListListener adapterUserItemListListener = null;
