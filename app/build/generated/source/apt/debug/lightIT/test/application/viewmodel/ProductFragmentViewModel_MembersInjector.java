...
public final class ProductFragmentViewModel_MembersInjector
    implements MembersInjector<ProductFragmentViewModel> {
  private final Provider<RepositoryApi> repositoryApiProvider;

  public ProductFragmentViewModel_MembersInjector(Provider<RepositoryApi> repositoryApiProvider) {
  ...
  public static MembersInjector<ProductFragmentViewModel> create(
    ...
    return new ProductFragmentViewModel_MembersInjector(repositoryApiProvider);
  }
