...
public class FragmentUserBindingImpl extends FragmentUserBinding  {
    ...
    private FragmentUserBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (lightIT.test.application.databinding.LayoutUserProgressBarBinding) bindings[1]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((FirstFragment) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((FirstFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable FirstFragment Handler) {
        this.mHandler = Handler;
    }
    public void setViewModel(@Nullable FirstFragmentViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeIncludeLayoutProgressBar((lightIT.test.application.databinding.LayoutUserProgressBarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeIncludeLayoutProgressBar(lightIT.test.application.databinding.LayoutUserProgressBarBinding IncludeLayoutProgressBar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        FirstFragmentViewModel viewModel = mViewModel;
