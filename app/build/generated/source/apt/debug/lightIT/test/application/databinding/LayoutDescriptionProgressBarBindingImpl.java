...
public class LayoutDescriptionProgressBarBindingImpl extends LayoutDescriptionProgressBarBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.progressBarDesc, 1);
    }
    // views
    // variables
    // values
    ...
    public LayoutDescriptionProgressBarBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private LayoutDescriptionProgressBarBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.ProgressBar) bindings[1]
            , (android.support.constraint.ConstraintLayout) bindings[0]
            );
        this.progressBarWrapDesc.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            this.progressBarWrapDesc.setVisibility(viewModelGetProgressBarEventViewVISIBLEViewGONE);
        }
    }
